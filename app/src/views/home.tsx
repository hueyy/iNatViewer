      ...
      <div className="lg:max-w-screen-xl lg:mx-auto mx-4">
        ...
        >
          ...
          <div className="w-full max-w-prose flex gap-4 my-4">
            ...
            />
            <label for="useAvif">
              Load images in AVIF format for smaller file size (uncheck
              this&nbsp;
        ...
        <section className="mt-6 container mx-auto mb-12" id="how-to-use">
          ...
          <p>
            ...
            tags for example. Once you are done, copy the URL and paste it in
            the input box above, then click "VIEW OBSERVATIONS".
          </p>
        </section>
      </div>
      <Footer />
